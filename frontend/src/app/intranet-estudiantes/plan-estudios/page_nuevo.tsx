...
import { FaArrowLeft, FaBook, FaCheckCircle, FaClock, FaExclamationTriangle, FaGraduationCap, FaCalendarCheck, FaCalendarTimes, FaFileAlt, FaChartLine, FaUser, FaMapMarkerAlt, FaPhone, FaEnvelope, FaIdCard, FaCalendarAlt, FaUniversity, FaUsers, FaChalkboardTeacher, FaInfoCircle } from "react-icons/fa";
              ...
              <div className="overflow-x-auto">
                <table className="min-w-full divide-y divide-gray-200">
                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    {materiasEstudiante.map((item, index) => (
