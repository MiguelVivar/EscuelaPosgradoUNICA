...
export default function InfoEstudiantePage() {
    ...
    const [selectedEstudiantePagos, setSelectedEstudiantePagos] = useState<PagoEstudiante[]>([]);
                ...
                {filtered.map((e) => {
                    ...
                    <tr key={e.id} className="hover:bg-gray-50 transition-colors">
                        ...
                        <div className="flex justify-end space-x-2">
                            <Button size="sm" variant="outline" onClick={() => handleViewEstudiante(e)} leftIcon={FaEye}>
                            Ver
                            </Button>
                            <Button 
                                size="sm" 
                            ...
                            {canManage && (
                            <Button size="sm" onClick={() => handleEditEstudiante(e)} leftIcon={FaEdit}>
                                Editar
                            </Button>
                            )}
                        </div>
        ...
        {showUploadModal && (
            ...
            <div className="bg-white rounded-xl shadow-2xl w-full max-w-lg mx-4 overflow-hidden">
                ...
                <div className="mb-6 p-4 bg-amber-50 rounded-lg border border-amber-200">
                    ...
                    <li>• Los códigos de estudiante deben ser <strong>únicos</strong></li>
                    </ul>
                    <button
            ...
            <div className="bg-white rounded-xl shadow-2xl w-full max-w-2xl mx-4 overflow-hidden">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <select
                        ...
                        onChange={(e) => setEditFormData({...editFormData, sedeId: e.target.value})}
                        className="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-transparent"
                    >
                                ...
                                <div className="flex items-center space-x-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-amber-100">
                                            {selectedEstudiante.nombres} {selectedEstudiante.apellidos} - {selectedEstudiante.codigo}
                                        </p>
                                    </div>
                                </div>
                                <button 
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                                        <div className="bg-green-50 p-4 rounded-lg border border-green-200">
                                            <div className="flex items-center justify-between">
                                                <div>
                                                    <p className="text-sm text-green-600">Pagos Realizados</p>
                                                    <p className="text-2xl font-bold text-green-800">
                                                        {selectedEstudiantePagos.filter(p => p.estado === EstadoPago.PAGADO).length}
                                                    </p>
                                                </div>
                                            ...
                                            <div className="flex items-center justify-between">
                                                <div>
                                                    ...
                                                    <p className="text-2xl font-bold text-yellow-800">
                                                        {selectedEstudiantePagos.filter(p => p.estado === EstadoPago.PENDIENTE).length}
                                                    </p>
                                                </div>
                                            ...
                                            <div className="flex items-center justify-between">
                                                <div>
                                                    ...
                                                    <p className="text-2xl font-bold text-red-800">
                                                        {selectedEstudiantePagos.filter(p => p.estado === EstadoPago.VENCIDO).length}
                                                    </p>
                                                </div>
                                                    ...
                                                    {selectedEstudiantePagos.map((pago) => (
                                                        <tr key={pago.id} className="hover:bg-gray-50">
                                                            ...
                                                            <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                                                {pago.fechaVencimiento ? new Date(pago.fechaVencimiento).toLocaleDateString() : 'Sin fecha'}
                                                            </td>
                                                            <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
