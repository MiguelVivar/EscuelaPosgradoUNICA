          ...
          <div className="bg-white/80 backdrop-blur-xl rounded-2xl shadow-xl border border-white/20 p-6 sm:p-8">
            <div className="text-center">
              ...
              <p className="text-gray-600 text-base sm:text-lg leading-relaxed max-w-4xl mx-auto">
                Módulo integral para la gestión académica y administrativa del posgrado.
                Centraliza las funciones clave del entorno virtual institucional, permitiendo el acceso seguro y personalizado a docentes, estudiantes y personal administrativo. Facilita la comunicación interna, el seguimiento académico, la gestión de trámites y la disponibilidad de información relevante para el desarrollo eficiente de las actividades del posgrado.
              </p>
